...
class RepositoryFilterSetTests(TestCase):
    def test_create_filters_expected(self):
        ...
        expected_filters = {
            ...
            'updated_at__gt', 'updated_at__gte', 'updated_at__lt', 'updated_at__lte', 'user_id', 'user_id__gt', 'user_id__gte',
            'user_id__lt', 'user_id__lte', 'watchers_count', 'watchers_count__gt', 'watchers_count__gte', 'watchers_count__lt',
            'watchers_count__lte'
        }
        self.assertEqual(set(filters.base_filters.keys()), expected_filters)
